#!/usr/bin/env python3
"""Module that combines all 5 previous plots into one figure."""
import numpy as np
...
# Plot 0: line graph (top-left)
ax0 = plt.subplot2grid((3, 2), (0, 0))
ax0.plot(y0, 'r-')
ax0.set_xlim(0, 10)

# Plot 1: scatter plot (top-right)
...
# Plot 2: change scale (middle-left)
...
# Plot 3: two curves (middle-right)
...
# Plot 4: histogram (bottom, spans both columns)
